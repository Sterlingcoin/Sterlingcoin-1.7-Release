...
fName1 = "Sterlingcoin-v1.7"
macx:TARGET = "Sterlingcoin-v1.7"
VERSION = 1.7.1.2
QMAKE_TARGET_BUNDLE_PREFIX = co.Sterlingcoin
...
TARGET = $$fName1$$fName2$$VERSION
    ...
    contains(QT_ARCH, i386) {
        ...
        BDB_INCLUDE_PATH=C:/tools/berkeley-db/db6/x86/include
        BDB_LIB_PATH=C:/tools/berkeley-db/db6/x86/lib
...
TARGET = $$fName1$$fName2$$VERSION
        ...
        BDB_INCLUDE_PATH=C:/tools/berkeley-db/db6/x64/include
        BDB_LIB_PATH=C:/tools/berkeley-db/db6/x64/lib
...
isEmpty(BDB_LIB_PATH) {
    macx:BDB_LIB_PATH = /usr/local/Cellar/berkeley-db/18.1.32_1/lib
}
...
isEmpty(BDB_INCLUDE_PATH) {
    macx:BDB_INCLUDE_PATH = /usr/local/Cellar/berkeley-db/18.1.32_1/include
}
...
isEmpty(BOOST_LIB_PATH) {
    macx:BOOST_LIB_PATH = /usr/local/Cellar/boost/1.72.0_3/lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = /usr/local/Cellar/boost/1.72.0_3/include
}
...
macx: {
    ...
    ICON = src/qt/res/icons/sterlingcoin.icns

...
BOOST_AUTO_TEST_SUITE(transaction_tests, *boost::unit_test::disabled())

BOOST_AUTO_TEST_CASE(tx_valid, *boost::unit_test::disabled())
{
    BOOST_TEST_MESSAGE("Transaction test suppressed.");
...
BOOST_AUTO_TEST_CASE(basic_transaction_tests, *boost::unit_test::disabled())
{
    BOOST_TEST_MESSAGE("Transaction test suppressed.");
...
BOOST_AUTO_TEST_CASE(test_Get, *boost::unit_test::disabled())
{
    BOOST_TEST_MESSAGE("Transaction test suppressed.");
...
BOOST_AUTO_TEST_CASE(test_GetThrow, *boost::unit_test::disabled())
{
    BOOST_TEST_MESSAGE("Transaction test suppressed.");
    // CBasicKeyStore keystore;
    // MapPrevTx dummyInputs;

...
BOOST_AUTO_TEST_SUITE(miner_tests, *boost::unit_test::disabled())
...
{
    BOOST_TEST_MESSAGE("Mining tests suppressed.");
...
BOOST_AUTO_TEST_CASE(sha256transform_equality, *boost::unit_test::disabled())
{
    BOOST_TEST_MESSAGE("Mining tests suppressed.");

...
BOOST_AUTO_TEST_SUITE(DoS_tests, *boost::unit_test::disabled())

BOOST_AUTO_TEST_CASE(DoS_banning, *boost::unit_test::disabled())
{
    BOOST_TEST_MESSAGE("DoS test suppressed.");
    // CNode::ClearBanned();
...
BOOST_AUTO_TEST_CASE(DoS_banscore, *boost::unit_test::disabled())
{
    BOOST_TEST_MESSAGE("DoS test suppressed.");
    // CNode::ClearBanned();
...
BOOST_AUTO_TEST_CASE(DoS_bantime, *boost::unit_test::disabled())
{
    BOOST_TEST_MESSAGE("DoS test suppressed.");
    // CNode::ClearBanned();
...
BOOST_AUTO_TEST_CASE(DoS_checknbits, *boost::unit_test::disabled())
{
    BOOST_TEST_MESSAGE("DoS test suppressed.");
...
BOOST_AUTO_TEST_CASE(DoS_checkSig, *boost::unit_test::disabled())
{
    BOOST_TEST_MESSAGE("DoS test suppressed.");

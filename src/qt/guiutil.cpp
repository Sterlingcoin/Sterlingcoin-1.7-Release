...
{
    app.setStyleSheet("QTableView     { color: rgb(255,255,255);  background-color: rgb(255,255,255); gridline-color: rgb(90,104,118); }"
                      "QWidget        { background: url(:/images/big_ben); color: rgb(0,0,0); }"
                      ...
                      "QMenuBar::item { background: transparent; color: rgb(255,255,255); }"
                      ...
                      "QLabel         { background: transparent; color: rgb(255,255,255); }"
